            ...
            <div className='container container-padding paddingY !mx-auto'>
                <div className="flex md:flex-row flex-col-reverse gap-6 mx-auto text-white w-full h-full items-end">
                    <div className="md:flex-2/3 w-full h-full">
                        <div className='mt-auto lg:w-[90%]'>
                            <h2 className='sub-head-text pb-4'>Build Your Future With Us</h2>
                            <p className='lg:text-lg'>We believe technology drives efficiency, but the real pillar is always our people inside. Over 70% of our team has been with us for more than 15 years. Why? It’s all about the work culture which is rooted in loyalty, innovation, and purpose. Whether it’s serving hospitals, hotels, or retail chains, you’ll be part of something that truly matters. We're a team that stays and grows together.</p>
                            <a
                                href="#"
                    ...
                    <div className="md:flex-1/3">
                        <img src={builfFuture} alt="build future" />
                    </div>
                </div>
            </div>
        </section>
