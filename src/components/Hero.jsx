...
const Hero = () => {
    ...
    return (
        <section
            className={`relative lg:min-h-[calc(100vh_-_100px)] min-h-[calc(100vh_-_70px)] bg-cover bg-center  flex flex-col justify-end`}
        >
            <motion.img
                src={hero}
                alt="Hero Background"
            ...
            <motion.div
                className="grid grid-cols-1 lg:grid-cols-5 gap-6 container container-padding paddingY !mx-auto relative z-10 "
                variants={containerVariants}
                initial="hidden"
                animate="visible"
            >
                <motion.div className="md:col-span-3" variants={wordContainerVariants}>
                ...
                <div className="md:col-span-2 mt-auto relative h-fit text-white overflow-hidden">
                    <img
                        loading="lazy"
                        src={heroItem}
